---
title: "Import and tidy data from the Solisense"
author:
- Maximilian Berthold
- Douglas A. Campbell
...
```{r set colours}
Wavelengths_nm = c(445, 590)
Colours_nm = c("dodgerblue", "darkorange")
...
#drop superfluous empty columns
SolFitsTrim <- SolFitsTrim %>%
  select(-c("Lon", "Lat", "GPS_stat"))
```
...
SolFitsTrim %>%
  ggplot() +
  geom_point(aes(x = ActPAR, y = FvFm, colour = Ex_WL)) +
